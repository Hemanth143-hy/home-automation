#if (SMUX_CHIP == 20719)
/*
 * This file is specific to this home_automation_control app only, the default pin configuration
 * for this platform can be found in the platforms/CYW920719Q40EVB_01/wiced_platform_pin_config.c
 * Please note that its mandatory to name this file in the format "home_automation_control_pin_config.c"
 */
